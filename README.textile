...
Then add following file in an initializer, (e.g. /config/initializers/i18n.rb)
...
There is a number custimization possible to achieve with ITS


h2. Automatic translations

If you know you want some keys being translated in a specific way, you can add those to @default_translations@
...
require "json"
require "iconv"
ts.key_translations_handler = lambda do |key, locale, spawner|
